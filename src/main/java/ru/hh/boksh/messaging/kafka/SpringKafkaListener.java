...
public class SpringKafkaListener {
  ...
  @KafkaListener(groupId = SPRING_GROUP_1, topics = "example_topic2")
  ...
  @KafkaListener(groupId = SPRING_GROUP_2, topics = "example_topic2")
  ...
  @KafkaListener(groupId = SPRING_GROUP_3, topics = "example_topic2")
